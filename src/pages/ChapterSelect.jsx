                ...
                <div className="space-y-1.5 max-w-md mx-auto">
                    {chapters.map((chapter)=>(
                        <button
                            ...
                            className="bg-white rounded-2xl p-5 w-full text-[#1b4965] font-bold ring-2 ring-[#5fa8d3]/30 hover:bg-[#bee9e8] transition text-base text-left min-h-[64px] items-center">
                            {chapter}
                        </button>
                    ))}
                </div>
